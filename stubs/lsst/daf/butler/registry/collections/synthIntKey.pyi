...
from ._base import CollectionTablesTuple, DefaultCollectionManager
...
class SynthIntKeyCollectionManager(DefaultCollectionManager):
    ...
    @classmethod
    def initialize(cls: Any, db: Database, context: StaticTablesContext, dimensions: DimensionRecordStorageManager) -> SynthIntKeyCollectionManager: ...
    @classmethod
