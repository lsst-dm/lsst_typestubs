import sqlalchemy
from ...core import DataCoordinateIterable, DatabaseDimensionElement, DimensionElement, DimensionRecord, GovernorDimension, NamedKeyDict, NamedKeyMapping, TimespanDatabaseRepresentation
...
class CachingDimensionRecordStorage(DatabaseDimensionRecordStorage):
    def __init__(self, nested: DatabaseDimensionRecordStorage) -> None: ...
    @classmethod
